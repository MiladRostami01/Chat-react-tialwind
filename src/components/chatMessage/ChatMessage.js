...
function ChatMessage() {
  ...
  return (
    ...
    <div className='absolute bottom-0 left-0 w-full bg-extraDark p-4 flex items-center justify-center'>
      <input type="text" name="" id="" placeholder='Type a message' className=' w-full p-2 rounded-lg bg-dark text-textColor active:shadow-none' />
    </div>
    {/* input end */}
    <ChatCard>
        <div className='w-[50px] h-[50px]'><img src={yoga} className='w-full h-full' alt="" /></div>
        <div>
    ...
    <div className='w-6/12 text-justify bg-ThemeBule p-4 rounded-t-xl rounded-r-xl
    my-4'>
      <p className='text-white'>Lorem ipsum dolor sit amet</p>
    </div>

    <div className='flex justify-end'>
      <p className='text-white w-6/12 text-justify bg-dark p-4 rounded-t-xl rounded-l-xl my-4'>Lorem ipsum dolor sit amet</p>
    </div>

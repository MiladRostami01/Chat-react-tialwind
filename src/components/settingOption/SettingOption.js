...
function SettingOption() {
  ...
  const gridStyle =
    "bg-extraDark md:flex md:flex-row md:items-center md:justify-between md:h-[150px] rounded-lg";
  const listStyle =
    "bg-extraDark md:flex md:flex-row md:items-center md:justify-between md:h-[110px] md:p-5 rounded-lg";
